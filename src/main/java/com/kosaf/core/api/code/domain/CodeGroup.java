...
public class CodeGroup {
  private String groupCd;            // 그룹코드 pk
  ...
  @Builder
  public CodeGroup(String groupCd, String cdNm, String expln, CodeStatus useYn, LocalDateTime regDt,
      Integer rgtrSysId, LocalDateTime mdfcnDt, Integer mdfrSysId) {
